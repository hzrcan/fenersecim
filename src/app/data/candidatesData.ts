...
export const candidates: Candidate[] = [
  {
    ...
    boardMembers: [
      { id: "b1", name: "Ali Aytemiz", position: "Yönetim Kurulu Üyesi (Asil Üye)" },
      { id: "b2", name: "Metin Doğan", position: "Yönetim Kurulu Üyesi (Asil Üye)" },
      { id: "b3", name: "Agah Ruşen Çetin", position: "Yönetim Kurulu Üyesi (Asil Üye)" },
      { id: "b4", name: "Metin Sipahioğlu", position: "Yönetim Kurulu Üyesi (Asil Üye)" },
      { id: "b5", name: "Dağlarca Çağlar", position: "Yönetim Kurulu Üyesi (Asil Üye)" },
      { id: "b6", name: "Rahmi Mertay Türk", position: "Yönetim Kurulu Üyesi (Asil Üye)" },
      { id: "b7", name: "Mustafa Ömer Topbaş", position: "Yönetim Kurulu Üyesi (Asil Üye)" },
      { id: "b8", name: "Özgür Özaktaç", position: "Yönetim Kurulu Üyesi (Asil Üye)" },
      { id: "b9", name: "Atakan Altınbaş", position: "Yönetim Kurulu Üyesi (Asil Üye)" },
      { id: "b10", name: "Orhan Turan", position: "Yönetim Kurulu Üyesi (Asil Üye)" },
      { id: "b11", name: "Selahattin Süleymanoğlu", position: "Yönetim Kurulu Üyesi (Asil Üye)" },
      { id: "b12", name: "Ogün Doğan", position: "Yönetim Kurulu Üyesi (Asil Üye)" },
      { id: "b13", name: "Şanser Özyıldırım", position: "Yönetim Kurulu Üyesi (Asil Üye)" },
      { id: "b14", name: "Taha Gökberk Doğan", position: "Yönetim Kurulu Üyesi (Asil Üye)" },
      { id: "b15", name: "Esra Öztürk Çilingir", position: "Yönetim Kurulu Üyesi (Yedek Üye)" },
      { id: "b16", name: "Ahmet Bulut", position: "Yönetim Kurulu Üyesi (Yedek Üye)" },
      { id: "b17", name: "Ahmet Murat Emanetoğlu", position: "Yönetim Kurulu Üyesi (Yedek Üye)" },
      { id: "b18", name: "Ertuğrul Eren Ergen", position: "Yönetim Kurulu Üyesi (Yedek Üye)" },
      { id: "b19", name: "Barış Öztürk", position: "Yönetim Kurulu Üyesi (Yedek Üye)" },
      { id: "b20", name: "Mustafa Enes Yıldırım", position: "Yönetim Kurulu Üyesi (Yedek Üye)" },
      { id: "b21", name: "Aras Bağ", position: "Yönetim Kurulu Üyesi (Yedek Üye)" }
    ],
    campaignContacts: [
  ...
  },
  {
    ...
    boardMembers: [
      { id: "b22", name: "Barış Göktürk", position: "Yönetim Kurulu Üyesi (Asil Üye)" },
      { id: "b23", name: "Mahmut Nedim Uslu", position: "Yönetim Kurulu Üyesi (Asil Üye)" },
      { id: "b24", name: "Nihat Özbağı", position: "Yönetim Kurulu Üyesi (Asil Üye)" },
      { id: "b25", name: "Mustafa Çağlar", position: "Yönetim Kurulu Üyesi (Asil Üye)" },
      { id: "b26", name: "Ahmet Önder Fırat", position: "Yönetim Kurulu Üyesi (Asil Üye)" },
      { id: "b27", name: "Cihan Kamer", position: "Yönetim Kurulu Üyesi (Asil Üye)" },
      { id: "b28", name: "Fatih Öztürk", position: "Yönetim Kurulu Üyesi (Asil Üye)" },
      { id: "b29", name: "Batuhan Özdemir", position: "Yönetim Kurulu Üyesi (Asil Üye)" },
      { id: "b30", name: "Tanju Kaya", position: "Yönetim Kurulu Üyesi (Asil Üye)" },
      { id: "b31", name: "Ahmet Murat İman", position: "Yönetim Kurulu Üyesi (Asil Üye)" },
      { id: "b32", name: "Özgür Peker", position: "Yönetim Kurulu Üyesi (Asil Üye)" },
      { id: "b33", name: "Yusuf Buğra Tanık", position: "Yönetim Kurulu Üyesi (Asil Üye)" },
      { id: "b34", name: "Mehmet Aydın", position: "Yönetim Kurulu Üyesi (Asil Üye)" },
      { id: "b35", name: "Mehmet Selim Kosif", position: "Yönetim Kurulu Üyesi (Asil Üye)" },
      { id: "b36", name: "Fatih Aslan", position: "Yönetim Kurulu Üyesi (Yedek Üye)" },
      { id: "b37", name: "Volkan Akan", position: "Yönetim Kurulu Üyesi (Yedek Üye)" },
      { id: "b38", name: "Mustafa Aydın Acun", position: "Yönetim Kurulu Üyesi (Yedek Üye)" },
      { id: "b39", name: "Barış Karagöz", position: "Yönetim Kurulu Üyesi (Yedek Üye)" },
      { id: "b40", name: "Savaş Adalet", position: "Yönetim Kurulu Üyesi (Yedek Üye)" },
      { id: "b41", name: "Demre İşcan", position: "Yönetim Kurulu Üyesi (Yedek Üye)" },
      { id: "b42", name: "Yasemin Babayiğit", position: "Yönetim Kurulu Üyesi (Yedek Üye)" }
    ],
    campaignContacts: [
